    ...
    <DashboardLayout>
      ...
      {!connected ? (
        <div className="space-y-6 mt-8">
          <Card>
            <CardHeader>
              <CardTitle>Configure Sender Identity</CardTitle>
              <CardDescription>
                Set up your email sending identity before connecting with Stripe
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...senderForm}>
                <form onSubmit={senderForm.handleSubmit(onSubmitSenderInfo)} className="space-y-4">
                  ...
                  <Button type="submit">Save Sender Information</Button>
                </form>
              </Form>
            </CardContent>
          </Card>
